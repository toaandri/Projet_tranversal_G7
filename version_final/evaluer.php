...
<body>
    ...
    <button class="logout-btn" onclick="window.location.href='evaluer.php?logout=true'">Déconnexion</button>
    <div class="eval-container">
        <h1>Évaluer un enseignant</h1>
        ...
        <form method="POST" action="evaluer.php">
            ...
            <textarea name="commentaire" rows="5" placeholder="Commentaire (optionnel)"></textarea>
            <input type="submit" value="Soumettre l'évaluation">
        </form>
